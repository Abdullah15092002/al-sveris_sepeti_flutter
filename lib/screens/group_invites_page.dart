...
class _GroupInvitesPageState extends State<GroupInvitesPage> {
        ...
        child: StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data?.data() == null) {
              return _buildEmptyState("Yeni davetiniz yok.");
            }
            ...
            if (invites.isEmpty) {
              return _buildEmptyState("Hiç davetiniz yok.");
            }
  ...
  // Kod tekrarını önlemek için "Boş Ekran" durumunu gösteren bir yardımcı metot.
